...
<body>
		...
		<div id="topContainer">
			...
			<div id="navBarContainer">
				<nav class="navBar">
					...
					<a href="index.php" class="navItem" class="logo" style="text-decoration: none; font-size: 25px; color: #02f766">
						HotHomeINC.
					</a>
    ...
    <div id="Cont" style="
                    height: 600px;
                    width: 100%;
                    background-image: url('style/images/bgi.jpg');
                    text-align: center;
                    border: 1px solid;
                ...
                <h1 id="motto" style="
                                            ...
                                            font-size: 4em;
                                            ">HotHomeINC.</h1>
                <h2 class="mottoh2" style="font-size: 2em;">Where Home Begins:)</h2>
    </div>
		
    <div id="mainViewContainer">

              <div id="mainContent">
                   <h1>Latest Properties Posts</h1>
              </div>
