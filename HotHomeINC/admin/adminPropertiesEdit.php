...
if(isset($_POST['submitButton']))
{
  ...
  $images=implode(' ',$data);
  $query = "UPDATE images SET images = '$images', address = '$property_address' WHERE name = '$name'";
...
$Successful = $account->updateProperty($id ,$property_title, $property_type, $property_description, $property_price, $property_address, $pimage, $property_contact, $name);
$plocation = "../displaypics/";
...
<body>
  ...
  if($Successful == true) {
    ...
    echo "<h1>Your Property Has Been Edited</h1>";
  }
